...
const Remain = () => {
  ...
  const [inctype] = useState("Adding/Changing");
  const [ques1] = useState("What subjects would you like to add?");
  const [ques2] = useState("What subjects would you like to change?");
