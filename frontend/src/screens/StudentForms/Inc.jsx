...
const Inc = () => {
  ...
  const [ques1] = useState("What subjects do you have incomplete?");
  const [ques2] = useState("What semester you had this incomplete?");
  const [ques3] = useState("Who is your professor in this subjects?");
  const [desc, setDesc] = useState("");
  const [inctype] = useState("Subjects with INC");
